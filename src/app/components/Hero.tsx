...
const Hero = () => {
  return (
    <div
      ...
      style={{ backgroundSize: '45px%', backgroundPosition: 'left 100px top 200px' }}
    >
      <Navbar />
      <div className="container grid lg:grid-cols-2 h-[calc(100vh-60px)]">
        <div className="hidden lg:block"></div>
        <div className="text-[70px] sm:text-[100px] font-bold leading-tight flex justify-center items-start mt-[600px]">
          <div>
